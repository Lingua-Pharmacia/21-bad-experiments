...
let lifetimeScore = parseInt(localStorage.getItem('badExperimentsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedBadExperimentsLessons')) || [];
if(ptsVal) ptsVal.innerText = lifetimeScore;

let wordBucket = []; let currentQ = 0; let attempts = 0; let totalScore = 0; let firstCard = null;

const stations = [
    {file:"01_StanfordPrison.mp3", title:"1. Stanford Prison Experiment"},
    {file:"02_MilgramObedience.mp3", title:"2. Milgram Obedience Experiment"},
    {file:"03_LittleAlbert.mp3", title:"3. The Little Albert Experiment"},
    {file:"04_BoboDoll.mp3", title:"4. Bobo Doll Experiment"},
    {file:"05_AschConformity.mp3", title:"5. Asch Conformity Experiment"},
    {file:"06_BystanderSeizure.mp3", title:"6. Bystander Seizure Study"},
    {file:"07_BlueEyesBrownEyes.mp3", title:"7. Blue Eyes/Brown Eyes Exercise"},
    {file:"08_RobbersCave.mp3", title:"8. Robbers Cave Experiment"},
    {file:"09_MonsterStudy.mp3", title:"9. The Monster Study"},
    {file:"10_ThirdWave.mp3", title:"10. The Third Wave"},
    {file:"11_CIA_MKUltra.mp3", title:"11. CIA MKUltra"},
    {file:"12_DavidReimer.mp3", title:"12. David Reimer Case"},
    {file:"13_RosenhanExperiment.mp3", title:"13. Rosenhan Experiment"},
    {file:"14_BrokenWindows.mp3", title:"14. Broken Windows Theory"},
    {file:"15_MarshmallowTest.mp3", title:"15. The Marshmallow Test"},
    {file:"16_ClarkDoll.mp3", title:"16. Clark Doll Test"},
    {file:"17_InvisibleGorilla.mp3", title:"17. Invisible Gorilla Experiment"},
    {file:"18_HawthorneEffect.mp3", title:"18. Hawthorne Effect"},
    {file:"19_PygmalionEffect.mp3", title:"19. Pygmalion Effect"},
    {file:"20_HaloEffect.mp3", title:"20. Halo Effect"},
    {file:"21_CognitiveDissonance.mp3", title:"21. Cognitive Dissonance Study"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('badExperimentsScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedBadExperimentsLessons', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
